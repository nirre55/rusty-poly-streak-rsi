...
#[expect(
    ...
    reason = "generated strategy feature builder keeps indicator states explicit"
)]
fn compute_feats(
    buf: &VecDeque<Candle>,
    rsi7: &RsiState,
...
static RULES: &[Rule] = &[
    ...
    (
        ...
        &[
            (3, 1, 18.00845307),
            (13, 1, 2.190740935),
            (9, 0, -0.02357829884_f64),
        ],
    ),
    // 16 GREEN micro_next_h1_green_16266
    (
        true,
        &[(10, 1, 8.202131158), (28, 2, 12.0), (21, 1, 32.08032065)],
    ),

...
fn compute_feats(
    ...
    let body_abs_pct = if close < 1e-12 {
        0.0
    } else {
        (cur.close - cur.open).abs() / close
    };
...
static RULES: &[Rule] = &[
    ...
    (
        true,
        &[(3, 1, 0.5066458518), (4, 2, 5.0), (1, 0, 9.290936623e-08)],
    ),
    // 3 GREEN micro_next_h1_green_34382
    (
        true,
        &[
            (5, 1, -0.01125914436_f64),
            (6, 0, 0.9656401664),
            (7, 1, 1.586225659),
        ],
    ),
    ...
    (
        ...
        &[
            (8, 1, -145.0194062_f64),
            (9, 1, 0.01349188119),
            (13, 1, 8.848352749e-05),
        ],
    ),
    // 8 GREEN micro_next_h1_green_4536
    (
        true,
        &[(3, 1, 3.592157413), (4, 2, 5.0), (8, 1, -145.0194062_f64)],
    ),
    ...
    (
        true,
        &[(3, 1, 3.592157413), (4, 2, 5.0), (21, 1, 18.94457115)],
    ),

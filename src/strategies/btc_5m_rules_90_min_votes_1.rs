...
fn count_color(buf: &VecDeque<Candle>, n: usize, green: bool) -> Option<f64> {
    if buf.len() < n { return None; }
    let c = buf.iter().rev().take(n).filter(|c| if green { c.close > c.open } else { c.close < c.open }).count();
    Some(c as f64)
}
...
fn compute_feats(
    buf: &VecDeque<Candle>,
    rsi8: &RsiState, rsi14: &RsiState, rsi21: &RsiState,
...
static RULES: &[Rule] = &[
    // 1 RED
    (false, [(16,0,98.87542722),(18,0,0.02486548257),(25,1,0.001638794532)]),
    // 2 GREEN
    (true,  [(6,1,-0.107140425),(11,2,13.0),(30,1,0.7579850134)]),
    // 3 GREEN
    (true,  [(22,1,-239.1832969),(8,1,0.0006406964493),(13,0,16.98439155)]),
    // 4 GREEN
    (true,  [(3,1,0.001457840018),(9,1,-0.01817602056),(30,0,3.587853962)]),
    // 5 GREEN
    (true,  [(1,1,-2.44769017),(8,1,0.0006406964493),(10,1,-0.004124811926)]),
    // 6 GREEN
    (true,  [(0,1,-2.774117242),(8,1,0.0006406964493),(17,0,10.74126157)]),
    // 7 GREEN
    (true,  [(15,1,33.28245704),(19,0,-0.005787322997),(21,1,-0.005476785129)]),
    // 8 GREEN
    (true,  [(6,1,-0.2340435963),(11,2,13.0),(21,0,-0.007134307442)]),
    // 9 GREEN
    (true,  [(0,1,-2.774117242),(8,1,0.0006406964493),(6,0,-0.2340435963)]),
    // 10 GREEN
    (true,  [(2,1,0.0008266398454),(10,1,-0.01970911953),(30,0,2.919374564)]),
    // 11 GREEN
    (true,  [(3,1,0.0006404179203),(11,2,14.0),(20,1,-0.01475596055)]),
    // 12 RED
    (false, [(4,0,-0.000239825686),(18,0,0.01939351557),(25,1,0.001638794532)]),
    // 13 GREEN
    (true,  [(22,1,-239.1832969),(0,0,-2.058231615),(25,1,0.001092315747)]),
    // 14 RED
    (false, [(31,0,0.001865948161),(16,0,97.6614989),(0,0,2.292740233)]),
    // 15 GREEN
    (true,  [(17,1,2.898900732),(4,1,-0.02994953395),(27,1,14.51065973)]),
    // 16 GREEN
    (true,  [(6,1,-0.107140425),(8,1,0.0004654084234),(7,0,0.0002988690878)]),
    // 17 GREEN
    (true,  [(6,1,-0.173645982),(11,2,13.0),(27,0,25.84167143)]),
    // 18 GREEN
    (true,  [(22,1,-209.9115581),(8,1,0.0007461976822),(7,0,0.0006619818413)]),
    // 19 GREEN
    (true,  [(0,1,-2.774117242),(8,1,0.0007461976822),(24,1,-130.1004463)]),
    // 20 GREEN
    (true,  [(22,1,-239.1832969),(8,1,0.0007461976822),(17,0,7.498316732)]),
    // 21 GREEN
    (true,  [(0,1,-2.487372513),(8,1,0.0004654084234),(23,0,-192.094143)]),
    // 22 GREEN
    (true,  [(0,1,-2.774117242),(7,1,0.0007499679689),(1,1,-3.032681751)]),
    // 23 RED
    (false, [(16,0,95.36043284),(31,0,0.002366750995),(0,0,2.046146229)]),
    // 24 RED
    (false, [(31,0,0.001865948161),(16,0,95.36043284),(29,0,73.95404425)]),
    // 25 RED
    (false, [(27,0,94.13387702),(4,0,-0.0001214530509),(17,1,99.45945562)]),
    // 26 RED
    (false, [(31,0,0.001865948161),(16,0,98.87542722),(20,1,0.03681466689)]),
    // 27 GREEN
    (true,  [(6,1,-0.2340435963),(21,0,-0.004431553752),(24,1,-153.295298)]),
    // 28 GREEN
    (true,  [(6,1,-0.2340435963),(21,0,-0.004431553752),(14,1,27.52356397)]),
    // 29 GREEN
    (true,  [(6,1,-0.107140425),(8,1,0.0006406964493),(2,0,0.001652921292)]),
    // 30 GREEN
    (true,  [(0,1,-2.774117242),(8,1,0.0006406964493),(27,1,18.35512826)]),
    // 31 RED
    (false, [(16,0,95.36043284),(10,0,0.01911639022),(5,1,-0.001380130085)]),
    // 32 GREEN
    (true,  [(6,1,-0.2340435963),(21,0,-0.004431553752),(28,1,27.45320025)]),
    // 33 GREEN
    (true,  [(0,1,-2.774117242),(8,1,0.0006406964493),(32,0,2.0)]),
    // 34 GREEN
    (true,  [(1,1,-2.668322486),(8,1,0.0004654084234),(28,1,31.37307417)]),
    // 35 GREEN
    (true,  [(3,1,0.0006404179203),(4,1,-0.02387268949),(32,1,1.0)]),
    // 36 RED
    (false, [(13,0,79.78754453),(11,2,21.0),(33,0,2.0)]),
    // 37 RED
    (false, [(16,0,95.36043284),(10,0,0.01911639022),(24,0,301.1917591)]),
    // 38 GREEN
    (true,  [(2,1,0.0008266398454),(19,1,-0.03454574655),(26,0,0.001054938882)]),
    // 39 RED
    (false, [(16,0,95.36043284),(7,0,0.005489115066),(8,1,0.003517992609)]),
    // 40 RED
    (false, [(31,0,0.001865948161),(16,0,95.36043284),(17,1,96.70846245)]),
    // 41 GREEN
    (true,  [(6,1,-0.107140425),(8,1,0.0006406964493),(17,0,4.53517561)]),
    // 42 GREEN
    (true,  [(17,1,1.091431392),(9,1,-0.01392502169),(32,1,1.0)]),
    // 43 RED
    (false, [(16,0,95.36043284),(9,0,0.01753783257),(25,1,0.001638794532)]),
    // 44 GREEN
    (true,  [(0,1,-2.487372513),(11,2,13.0),(30,1,1.219114982)]),
    // 45 RED
    (false, [(16,0,95.36043284),(10,0,0.02432417868),(25,1,0.001638794532)]),
    // 46 RED
    (false, [(16,0,95.36043284),(18,0,0.01939351557),(12,2,4.0)]),
    // 47 GREEN
    (true,  [(0,1,-2.774117242),(21,0,-0.004431553752),(1,1,-3.385888687)]),
    // 48 GREEN
    (true,  [(6,1,-0.06443813881),(8,1,0.0004654084234),(15,0,39.3931585)]),
    // 49 GREEN
    (true,  [(0,1,-2.774117242),(2,1,0.001228070749),(11,2,6.0)]),
    // 50 GREEN
    (true,  [(3,1,0.001457840018),(1,1,-3.385888687),(4,0,-0.007190350995)]),
    // 51 RED
    (false, [(9,0,0.008390907843),(4,0,-0.0003773777571),(25,1,0.0)]),
    // 52 GREEN
    (true,  [(3,1,0.001457840018),(1,1,-3.385888687),(21,1,-0.0156322462)]),
    // 53 GREEN
    (true,  [(0,1,-2.304024546),(11,2,22.0),(26,1,9.223945209e-08)]),
    // 54 RED
    (false, [(0,0,2.783849801),(11,2,9.0),(1,1,3.429563387)]),
    // 55 GREEN
    (true,  [(0,1,-2.774117242),(10,0,-0.005758468918),(9,1,-0.004965357046)]),
    // 56 GREEN
    (true,  [(0,1,-2.774117242),(10,0,-0.005758468918),(11,2,13.0)]),
    // 57 RED
    (false, [(4,0,-0.000509590257),(2,1,0.0005943956918),(25,1,3.702010378e-07)]),
    // 58 GREEN
    (true,  [(13,1,31.93496681),(20,0,0.0242546669),(10,0,-0.007039969776)]),
    // 59 GREEN
    (true,  [(2,1,0.0008266398454),(21,1,-0.0156322462),(20,0,-0.02315688552)]),
    // 60 RED
    (false, [(13,0,79.78754453),(11,2,21.0),(14,1,73.34429789)]),
    // 61 GREEN
    (true,  [(0,1,-2.774117242),(18,0,-0.005712097907),(15,1,31.37459303)]),
    // 62 GREEN
    (true,  [(15,1,33.28245704),(19,0,-0.005787322997),(6,1,-0.173645982)]),
    // 63 GREEN
    (true,  [(6,1,-0.2340435963),(21,0,-0.004431553752),(9,1,-0.004083019831)]),
    // 64 GREEN
    (true,  [(0,1,-2.774117242),(15,0,31.37459303),(2,1,0.0001481980796)]),
    // 65 RED
    (false, [(0,0,3.068414947),(12,2,5.0),(1,0,3.429563387)]),
    // 66 RED
    (false, [(5,0,-0.000212151614),(11,2,12.0),(6,1,1.061948757)]),
    // 67 RED
    (false, [(9,0,0.01364096683),(25,1,0.0),(26,1,0.001347937908)]),
    // 68 GREEN
    (true,  [(0,1,-2.487372513),(11,2,11.0),(9,0,-0.004965357046)]),
    // 69 GREEN
    (true,  [(6,1,-0.06443813881),(11,2,13.0),(12,2,5.0)]),
    // 70 GREEN
    (true,  [(13,1,23.24758078),(3,0,0.03033879208),(0,1,-2.304024546)]),
    // 71 GREEN
    (true,  [(13,1,31.93496681),(2,0,0.03468189691),(5,0,-0.02252162313)]),
    // 72 GREEN
    (true,  [(0,1,-2.058231615),(2,0,0.02558085724),(5,0,-0.02252162313)]),
    // 73 GREEN
    (true,  [(6,1,-0.2340435963),(2,1,0.001228070749),(12,2,1.0)]),
    // 74 GREEN
    (true,  [(0,1,-2.774117242),(9,0,-0.002956606273),(15,1,35.7929937)]),
    // 75 RED
    (false, [(0,0,3.068414947),(12,2,5.0),(18,1,0.004280476703)]),
    // 76 RED
    (false, [(0,0,3.068414947),(1,1,1.903776951),(3,1,0.03033879208)]),
    // 77 GREEN
    (true,  [(0,1,-2.487372513),(11,2,22.0),(30,1,0.7579850134)]),
    // 78 GREEN
    (true,  [(6,1,-0.2340435963),(21,0,-0.004431553752),(3,1,0.001091384768)]),
    // 79 RED
    (false, [(13,0,79.78754453),(12,2,5.0),(15,1,64.95549342)]),
    // 80 RED
    (false, [(0,0,2.783849801),(12,2,5.0),(5,1,-0.001004677022)]),
    // 81 GREEN
    (true,  [(6,1,-0.2340435963),(14,0,35.01130025),(21,1,-0.003142104413)]),
    // 82 GREEN
    (true,  [(6,1,-0.005731108736),(2,0,0.02923394723),(3,0,0.04226528076)]),
    // 83 GREEN
    (true,  [(6,1,-0.107140425),(11,2,22.0),(19,0,-0.005787322997)]),
    // 84 GREEN
    (true,  [(0,1,-2.774117242),(10,0,-0.005758468918),(3,1,0.001091384768)]),
    // 85 GREEN
    (true,  [(0,1,-2.487372513),(11,2,13.0),(9,0,-0.004083019831)]),
    // 86 RED
    (false, [(14,0,77.03278368),(11,2,11.0),(30,1,2.919374564)]),
    // 87 RED
    (false, [(13,0,73.82299439),(20,1,-0.01475596055),(1,1,1.450800747)]),
    // 88 RED
    (false, [(9,0,0.01364096683),(4,0,-0.000509590257),(19,1,0.0173612306)]),
    // 89 RED
    (false, [(0,0,2.783849801),(1,1,1.450800747),(18,0,0.004280476703)]),
    // 90 GREEN
    (true,  [(6,1,-0.107140425),(11,2,11.0),(3,1,0.004305280217)]),
];
...
impl BtcRules90 {
    ...
    fn vote(&mut self) -> (u32, u32) {
        let feats = compute_feats(
            &self.buffer,
            &self.rsi8, &self.rsi14, &self.rsi21,
...
impl Strategy for BtcRules90 {
    ...
    fn current_rsi(&self) -> Option<f64> { self.rsi14.get() }
